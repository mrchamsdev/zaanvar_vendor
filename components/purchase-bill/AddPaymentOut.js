    ...
    const handleSave = async () => {
        ...
        try {
            ...
            try {
                ...
                const sendMsg = msgSettings?.sendPaymentOutMessageToSupplier;
                const autoMessageEvents = msgSettings?.autoMessageEvents;
                const isAutoEnabled = Array.isArray(autoMessageEvents)
                    ? autoMessageEvents.includes("Payment out")
                    : !!autoMessageEvents?.paymentOut;
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{ margin: "0 0 24px", fontSize: 14, color: "#666", lineHeight: 1.5 }}>
                            Do you want to send the payment out message to the supplier?
                        </p>
