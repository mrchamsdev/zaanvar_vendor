                            ...
                            return (
                                <React.Fragment key={t.suppliersTransactionId || idx}>
                                    <tr className={styles.trHistory}>
                                        ...
                                        <td className={styles.td}>₹ {Number(t.relatedBill?.overallBillAmount || t.overallBillAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
