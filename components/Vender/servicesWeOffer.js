...
//!   Location 
  {
    ...
    text: "BOOK YOUR TICKETS TO ENJOY",
    para:"The smart location based search of Zaanvar helps locate nearby pet services without difficulties. You can find a trusted provider of the trainer, groomer, vet, or even store, and we assist you in it and help find the nearest one.",
...
WITH YOUR PETS
          ...
          <p className={styles["para"]}>
           {mainImages[activeIndex].para} <span className={styles["span-data"]}>{mainImages[activeIndex].span}</span> </p>
