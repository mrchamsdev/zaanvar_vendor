...
// //   useEffect(() => {
// //   if (slug) {
// //     // We no longer split the slug. 
// //     // We pass the complete string "GOLDEN-RETRIEVER-20260327-004-878"
...
// //     // Pass the complete slug as the ID parameter
...
// //     // Log the exact URL attempted to verify if it's hitting the right endpoint
...
// //   return new Date(pet.createdDate).toISOString().split("T")[0]; // YYYY-MM-DD
// // };
...
// //                           ? pet.petImage
// //                           : `https://zaanvar-care.b-cdn.net/${pet.morePhotos[0]}`
...
// //                 <p>{pet?.address || "Unknown Location"}</p>
...
//   // If it's an object, check if it has at least one actual value inside
...
//     {typeof pet.address === 'object' ? (
//       <>
//         <p><b>Street:</b> {pet.address.street}</p>
//         <p>{pet.address.city}, {pet.address.state} - {pet.address.pincode}</p>
//         {pet.address.landmark && <p><small>Landmark: {pet.address.landmark}</small></p>}
//       </>
//     ) : (
//       <p>{pet.address}</p>
//     )}
...
//               {/* Additional Information - Only show if any field has value */}
...
//                     <div className={styles["row2"]}>
//                       <div className={styles["label2"]}>How many Vaccinations Done?</div>
//                       <div className={styles["value"]}>{pet?.vaccinated}</div>
//                     </div>
//                   )}
...
//                       {shouldShow(pet?.variety) && (
//                         <div className={styles["row"]}>
//                           <Call />
//                           <div className={styles["label"]}>Pet Variety</div>
//                           <div className={styles["value"]}>{pet?.variety}</div>
//                         </div>
//                       )}
//                     </div>
//                   </div>
...
//         {/* Mobile additional info - Only show if any field has value */}
//         {(shouldShow(pet?.vaccinated) || 
//           shouldShow(pet?.negotiable) || 
//           shouldShow(pet?.father) || 
//           shouldShow(pet?.mother) || 
...
//     try {
//       const response = await webApi.delete(`vendorPetSales//${pet?.id}`);
